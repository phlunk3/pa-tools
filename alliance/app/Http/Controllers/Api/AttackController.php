...
class AttackController extends ApiController
{
	...
	public function store(AttackRequest $request, ParseCoordsList $coordParser)
	{
		...
		$attack = Attack::create([
			...
			'prerelease_time' => $request->input('prerelease_time'),
			'attack_id' => 'temp'
		]);
	...
	public function prereleased()
	{
		return Attack::where(['is_prereleased' => 1, 'is_closed' => 0, 'is_opened' => 0])->get();
	}
