				...
				<div class="card card-default">
					...
					<div class="card-body">
						...
						<form @submit.prevent="handleSubmit" v-if="!userLoading">
							<div class="row justify-content-center">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="text" v-model="password" placeholder="Leave blank for no change"><br/>
										<small class="help">Leave blank for no change</small>
									</div>
									<div class="form-group">
										...
										<small class="help">Used in various places for a better user experience</small>
									</div>
									<div class="form-group">
										<label for="phone">Phone</label><br>
										<input type="text" v-model="phone"><br/>
										<small class="help">Used for Planetarion Notifications and !call or !sms in Telegram channel</small>
									</div>
									<div class="form-group" v-if="settings.twilio">
										<span class="toggle-wrapper" style="margin-left: 0"><span class="toggle-label">Allow Nightime Usage</span><toggle-button :width="40" v-model="allow_night" class="toggle-button" /></span>
									</div>
								   <div class="form-group">
									   <span class="toggle-wrapper" style="margin-left: 0"><span class="toggle-label">Enable SMS Notifications</span><toggle-button :width="40" v-model="allow_notifications" class="toggle-button" /></span>
								   </div>
									<div class="form-group">
									...
									<div class="form-group" v-if="settings.telegram">
										...
										<small class="help">Type !setnick &lt;PA Nick&gt; into Telegram channel</small>
									</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" id="coord_x" placeholder="x" size="2" v-model.number="x" style="width: 40px" disabled="true">:
										<input type="number" id="coord_y" placeholder="y" size="2" v-model.number="y" style="width: 40px" disabled="true">:
										<input type="number" id="coord_z" placeholder="z" size="2" v-model.number="z" style="width: 40px" disabled="true">
									</div>
							...
							<div class="row justify-content-center" v-if="notification_email">
								<div class="col-md-6">
									<div class="form-group">
										...
										<small class="help">Add this email address to Planetarion Preferences</small>
									</div>
								</div>
								<div class="col-md-6">
								</div>
							...
							<div class="form-group">
								<label for="name">Notifications Email Forward</label><br>
								<input type="text" v-model="notification_email_forward"><br/>
								<small class="help">Forward notifications to this address (blank for none)</small>
							</div>
	...
	export default {
		...
		methods: {
			handleSubmit() {
				axios.post('api/v1/account', {
					...
					allow_night: this.allow_night,
					allow_notifications: this.allow_notifications,
					notification_email: this.notification_email_forward,
					notification_email_forward: this.notification_email_forward
		...
		mounted() {
			...
			.then((response) => {
				...
				this.allow_night		= this.account.allow_night;
				this.allow_notifications= this.account.allow_notifications;
				this.notification_email = this.account.notification_email;
				this.notification_email_forward = this.account.notification_email_forward;
