		...
		<div class="nav-header">
			...
			<nav class="navbar navbar-expand-lg d-lg-none navbar-light navbar-laravel mobile" v-show="nav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><router-link class="nav-link" to="/schedule" :class="{'active': subIsActive('/schedule')}">Schedule</router-link></li>
					...
					<li class="nav-item"><router-link class="nav-link" to="/battlegroups" :class="{'active': subIsActive('/battlegroups')}">Battlegroups</router-link></li>
