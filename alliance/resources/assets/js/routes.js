...
import BattlegroupFleets from './components/pages/BattlegroupFleets.vue';
...
export const routes = [
	...
	{ path: '/battlegroups/:id/fleets/:user_id', component: BattlegroupFleets, name: 'battlegroup_fleets', props: true },
	{ path: '/schedule', component: Schedule, name: 'schedule', props: true }
