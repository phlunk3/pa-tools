...
/* ucp_header.html */
class __TwigTemplate_48dfec1e6dabaa7f2b911e08de7686f2256d96fdb7b8fb70471cee9bf40064c6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["t_block1"]) {
            ...
            echo "\"><a class=\"hvr-sweep-to-top\" href=\"";
...
\t\t\t\t\t";
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["t_block2"], "S_SELECTED", [], "any", false, false, false, 29)) {
                        // line 30
                        echo "\t\t\t\t\t\t<li id=\"active-subsection\" class=\"active-subsection\"><a class=\"hvr-sweep-to-top\" href=\"";
...
\t\t\t\t\t";
                        ...
                        // line 32
                        echo "\t\t\t\t\t\t<li><a class=\"hvr-sweep-to-top\" href=\"";
...
\t\t\t\t";
            // line 76
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "friends_offline", [], "any", false, false, false, 76));
            foreach ($context['_seq'] as $context["_key"] => $context["friends_offline"]) {
                ...
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["friends_offline"], "USERNAME_FULL", [], "any", false, false, false, 77);
                echo " ";
                if (($context["S_SHOW_PM_BOX"] ?? null)) {
                    echo "<input type=\"submit\" name=\"add_to[";
                    echo twig_get_attribute($this->env, $this->source, $context["friends_offline"], "USER_ID", [], "any", false, false, false, 77);
                    echo "]\" value=\"";
                    echo $this->extensions['phpbb\template\twig\extension']->lang("ADD");
                    echo "\" class=\"button2\" />";
                }
...
\t\t\t\t";
            // line 92
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "pm_colour_info", [], "any", false, false, false, 92));
            foreach ($context['_seq'] as $context["_key"] => $context["pm_colour_info"]) {
                // line 93
                echo "\t\t\t\t\t<dd class=\"pm-legend";
                if (twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "CLASS", [], "any", false, false, false, 93)) {
                    echo " ";
                    echo twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "CLASS", [], "any", false, false, false, 93);
                }
                echo "\">";
                if (twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "IMG", [], "any", false, false, false, 93)) {
                    echo twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "IMG", [], "any", false, false, false, 93);
                    echo " ";
                }
                echo twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "LANG", [], "any", false, false, false, 93);
                echo "</dd>
\t\t\t\t";
            }
            $_parent = $context['_parent'];
