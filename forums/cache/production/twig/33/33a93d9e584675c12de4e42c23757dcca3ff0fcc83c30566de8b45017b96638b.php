...
class __TwigTemplate_ce016cf0fa41065a61c8cedd3bd1eb1b52fea4c59c97bd6f0da00920e7f78cbf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["notifications"], "URL", [], "any", false, false, false, 22)) {
                // line 23
                echo "\t\t\t\t\t\t<a class=\"notification-block hvr-sweep-to-top\" href=\"";
