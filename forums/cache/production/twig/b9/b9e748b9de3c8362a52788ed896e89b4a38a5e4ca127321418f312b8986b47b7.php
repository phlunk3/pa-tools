...
class __TwigTemplate_8c3af6f665f394d6d3d61bcf4fcabff23ce8d73bd94a1474b4cbdf99d7c356b2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        if (($context["S_CONFIRM_REFRESH"] ?? null)) {
            echo "<input type=\"submit\" name=\"refresh_vc\" id=\"refresh_vc\" class=\"button2 hvr-sweep-to-top\" value=\"";
