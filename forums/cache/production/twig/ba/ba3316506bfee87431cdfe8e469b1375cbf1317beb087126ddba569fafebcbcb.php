...
class __TwigTemplate_ef5118fa99c7d68ad50351f2252beeddbb5b147555db97cfe976709dc0ec53b3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<input class=\"button1 hvr-sweep-to-top\" type=\"submit\" name=\"submit_export\" value=\"";
            // line 27
            echo $this->extensions['phpbb\template\twig\extension']->lang("EXPORT_FOLDER");
            echo "\" />&nbsp;
\t\t<input class=\"button2 hvr-sweep-to-top\" type=\"reset\" value=\"";
            // line 28
...
\t\t\t<div class=\"left-box\"><label for=\"export_option\">";
                ...
                echo "</option></select></label> <input class=\"button2 hvr-sweep-to-top\" type=\"submit\" name=\"submit_export\" value=\"";
...
\t\t\t<select name=\"mark_option\">";
                ...
                echo "</select> <input class=\"button2 hvr-sweep-to-top\" type=\"submit\" name=\"submit_mark\" value=\"";
                echo $this->extensions['phpbb\template\twig\extension']->lang("GO");
                echo "\" />
