...
/* posting_editor.html */
class __TwigTemplate_36caf1059d972fddc23ae8bfd514952d03009a3b0e71145b6bc0896cad800bfe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
            ...
            if ((($context["CAPTCHA_TEMPLATE"] ?? null) && ($context["S_CONFIRM_CODE"] ?? null))) {
                ...
                $this->loadTemplate((("" . ($context["CAPTCHA_TEMPLATE"] ?? null)) . ""), "posting_editor.html", 41)->display($context);
                if ($namespace) {
...
\t";
        ...
        $this->loadTemplate("posting_buttons.html", "posting_editor.html", 47)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
        // line 48
...
\t\t";
        ...
        // line 51
        echo "\t\t";
        if ((($context["S_SMILIES_ALLOWED"] ?? null) && twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "smiley", [], "any", false, false, false, 51)))) {
            // line 52
            echo "\t\t\t<strong>";
...
\t\t\t";
            // line 53
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "smiley", [], "any", false, false, false, 53));
            foreach ($context['_seq'] as $context["_key"] => $context["smiley"]) {
                // line 54
                echo "\t\t\t\t<a href=\"#\" onclick=\"insert_text('";
                echo twig_get_attribute($this->env, $this->source, $context["smiley"], "A_SMILEY_CODE", [], "any", false, false, false, 54);
                echo "', true); return false;\"><img src=\"";
                echo twig_get_attribute($this->env, $this->source, $context["smiley"], "SMILEY_IMG", [], "any", false, false, false, 54);
                echo "\" width=\"";
                echo twig_get_attribute($this->env, $this->source, $context["smiley"], "SMILEY_WIDTH", [], "any", false, false, false, 54);
                echo "\" height=\"";
                echo twig_get_attribute($this->env, $this->source, $context["smiley"], "SMILEY_HEIGHT", [], "any", false, false, false, 54);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["smiley"], "SMILEY_CODE", [], "any", false, false, false, 54);
                echo "\" title=\"";
                echo twig_get_attribute($this->env, $this->source, $context["smiley"], "SMILEY_DESC", [], "any", false, false, false, 54);
                echo "\" /></a>
\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t";
            // line 63
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "smiley", [], "any", false, false, false, 63))) {
                echo "<hr />";
            }
            // line 64
            echo "\t\t\t";
...
";
        // line 90
        if ((twig_get_attribute($this->env, $this->source, ($context["definition"] ?? null), "EXTRA_POSTING_OPTIONS", [], "any", false, false, false, 90) == 1)) {
            // line 91
            echo "
\t";
            // line 92
...
\t";
            // line 97
            if (( !($context["S_SHOW_DRAFTS"] ?? null) && ( !twig_get_attribute($this->env, $this->source, ($context["definition"] ?? null), "SIG_EDIT", [], "any", false, false, false, 97) == 1))) {
                // line 98
                echo "\t<div id=\"bgfieldset-buttons\" class=\"panel bg2\">
\t\t<div class=\"inner\">
\t\t<fieldset class=\"submit-buttons buttons-editor\">
\t\t\t";
                // line 101
...
\t\t\t";
                ...
                if (($context["S_HAS_DRAFTS"] ?? null)) {
                    ...
                    echo "\" class=\"button2 hvr-sweep-to-top\" onclick=\"load_draft = true;\" />&nbsp; ";
                }
                // line 105
                echo "\t\t\t";
                ...
                echo "\" class=\"button1 hvr-sweep-to-top\"";
...
\t";
            ...
            if ((( !($context["S_PRIVMSGS"] ?? null) &&  !($context["S_SHOW_DRAFTS"] ?? null)) && ( !twig_get_attribute($this->env, $this->source, ($context["definition"] ?? null), "SIG_EDIT", [], "any", false, false, false, 115) == 1))) {
                ...
                echo "\" role=\"tablist\">
\t\t\t<ul>
\t\t\t\t<li id=\"options-panel-tab\" class=\"tab activetab\"><a class=\"hvr-sweep-to-top\" href=\"#tabs\" data-subpanel=\"options-panel\" role=\"tab\" aria-controls=\"options-panel\"><span>";
                // line 118
...
\t\t\t\t\t\t<a class=\"hvr-sweep-to-top\" href=\"#tabs\" data-subpanel=\"attach-panel\" role=\"tab\" aria-controls=\"attach-panel\">
\t\t\t\t\t\t\t";
                    // line 122
...
\t\t\t\t\t\t<a class=\"hvr-sweep-to-top\" href=\"#tabs\" data-subpanel=\"poll-panel\" role=\"tab\" aria-controls=\"poll-panel\">";
                    // line 128
...
\t";
            // line 136
            if (( !($context["S_SHOW_DRAFTS"] ?? null) && ( !twig_get_attribute($this->env, $this->source, ($context["definition"] ?? null), "SIG_EDIT", [], "any", false, false, false, 136) == 1))) {
                // line 137
...
\t\t\t\t<dd>";
                    // line 171
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "topic_type", [], "any", false, false, false, 171));
                    foreach ($context['_seq'] as $context["_key"] => $context["topic_type"]) {
                        echo "<label for=\"topic_type-";
                        echo twig_get_attribute($this->env, $this->source, $context["topic_type"], "VALUE", [], "any", false, false, false, 171);
                        echo "\"><input type=\"radio\" name=\"topic_type\" id=\"topic_type-";
                        echo twig_get_attribute($this->env, $this->source, $context["topic_type"], "VALUE", [], "any", false, false, false, 171);
                        echo "\" value=\"";
                        echo twig_get_attribute($this->env, $this->source, $context["topic_type"], "VALUE", [], "any", false, false, false, 171);
                        echo "\"";
                        echo twig_get_attribute($this->env, $this->source, $context["topic_type"], "S_CHECKED", [], "any", false, false, false, 171);
                        echo " />";
                        echo twig_get_attribute($this->env, $this->source, $context["topic_type"], "L_TOPIC_TYPE", [], "any", false, false, false, 171);
                        echo "</label> ";
                    }
                    $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  695 => 202,  691 => 200,  685 => 197,  680 => 196,  677 => 195,  675 => 194,  672 => 193,  668 => 191,  662 => 189,  660 => 188,  654 => 187,  649 => 186,  645 => 184,  643 => 183,  640 => 182,  634 => 179,  628 => 178,  623 => 177,  620 => 176,  618 => 175,  615 => 174,  592 => 171,  583 => 170,  580 => 169,  578 => 168,  575 => 167,  571 => 165,  569 => 164,  566 => 163,  556 => 161,  553 => 160,  545 => 158,  542 => 157,  534 => 155,  531 => 154,  523 => 152,  520 => 151,  512 => 149,  509 => 148,  501 => 146,  498 => 145,  490 => 143,  487 => 142,  486 => 141,  480 => 137,  478 => 136,  475 => 135,  470 => 132,  468 => 131,  462 => 128,  459 => 127,  456 => 126,  449 => 122,  445 => 120,  443 => 119,  439 => 118,  429 => 116,  427 => 115,  424 => 114,  414 => 107,  405 => 106,  398 => 105,  391 => 104,  390 => 103,  386 => 102,  382 => 101,  377 => 98,  375 => 97,  372 => 96,  367 => 93,  365 => 92,  362 => 91,  360 => 90,  356 => 88,  355 => 87,  341 => 84,  337 => 82,  336 => 81,  332 => 79,  329 => 78,  322 => 77,  313 => 76,  308 => 75,  305 => 74,  303 => 73,  296 => 70,  291 => 68,  287 => 67,  282 => 66,  280 => 65,  275 => 64,  271 => 63,  268 => 62,  265 => 61,  263 => 60,  255 => 58,  252 => 57,  249 => 56,  230 => 54,  226 => 53,  221 => 52,  218 => 51,  217 => 50,  213 => 48,  201 => 47,  198 => 46,  197 => 45,  194 => 44,  191 => 43,  188 => 42,  175 => 41,  171 => 40,  169 => 39,  165 => 37,  164 => 36,  152 => 35,  151 => 34,  145 => 32,  142 => 31,  140 => 30,  137 => 29,  136 => 28,  133 => 27,  127 => 24,  122 => 23,  119 => 22,  117 => 21,  114 => 20,  113 => 19,  110 => 18,  105 => 15,  103 => 14,  76 => 13,  68 => 12,  65 => 11,  64 => 10,  58 => 8,  55 => 7,  53 => 6,  50 => 5,  49 => 4,  46 => 3,  40 => 2,  37 => 1,);
    }
