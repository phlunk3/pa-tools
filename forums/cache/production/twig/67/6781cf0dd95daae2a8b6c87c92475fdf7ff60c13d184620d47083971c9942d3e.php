...
/* viewtopic_body.html */
class __TwigTemplate_186f5344e285ea3e1c7dc7156935095e8750fd30002b1cd6466ba4fe3cb985e1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "pagination", [], "any", false, false, false, 64)) || ($context["TOTAL_POSTS"] ?? null))) {
            // line 65
            echo "\t\t<div class=\"pagination pagination-topic-top\">
\t\t\t";
            // line 66
...
\t\t\t\t\t\t\t<a href=\"";
                        ...
                        echo "\" class=\"button hvr-sweep-to-top button-icon-only\">
...
\t\t\t\t\t<strong>";
                    ...
                    echo "</strong>
\t\t\t\t\t<input class=\"button2 hvr-sweep-to-top\" type=\"submit\" value=\"";
                    // line 307
                    echo $this->extensions['phpbb\template\twig\extension']->lang("DISAPPROVE");
                    echo "\" name=\"action[disapprove]\" />
\t\t\t\t\t<input class=\"button1 hvr-sweep-to-top\" type=\"submit\" value=\"";
                    // line 308
...
\t\t\t\t\t";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["postrow"], "S_DELETE_PERMANENT", [], "any", false, false, false, 323)) {
                    // line 324
                    echo "\t\t\t\t\t\t<input class=\"button2 hvr-sweep-to-top\" type=\"submit\" value=\"";
                    echo $this->extensions['phpbb\template\twig\extension']->lang("DELETE");
                    echo "\" name=\"action[delete]\" />
\t\t\t\t\t";
                }
                // line 326
                echo "\t\t\t\t\t<input class=\"button1 hvr-sweep-to-top\" type=\"submit\" value=\"";
...
";
        // line 398
        // line 399
        echo "\t<div class=\"action-bar bar-bottom viewtopics-bar-bottom\">
\t";
        // line 400
        // line 401
        echo "
...
\t";
        ...
        $this->loadTemplate("jumpbox-2.html", "viewtopic_body.html", 441)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
        // line 442
...
";
        ...
        $this->loadTemplate("jumpbox-4.html", "viewtopic_body.html", 445)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
        // line 446
