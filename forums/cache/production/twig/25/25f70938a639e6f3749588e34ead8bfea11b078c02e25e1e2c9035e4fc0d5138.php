...
class __TwigTemplate_3ce107903251269d20de46364464948a0acd98f383970e179c1fe566db05e47b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        if (((($context["U_POST_REPLY_PM"] ?? null) || ($context["U_POST_NEW_TOPIC"] ?? null)) || ($context["U_FORWARD_PM"] ?? null))) {
            ...
            if (($context["U_POST_REPLY_PM"] ?? null)) {
                ...
                echo "\" class=\"button hvr-sweep-to-top\">
\t\t\t\t<span>";
                // line 13
...
\t";
        ...
        if ((($context["TOTAL_MESSAGES"] ?? null) || ($context["S_VIEW_MESSAGE"] ?? null))) {
            // line 54
            echo "\t\t<div class=\"pagination pagi-pm-folder\">
\t\t\t";
            // line 55
