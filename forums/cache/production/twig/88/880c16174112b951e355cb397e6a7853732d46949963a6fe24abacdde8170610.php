...
/* pagination.html */
class __TwigTemplate_3b43774d482efba196da2abfd5cdfd5a696330a397f287961c91a937c49f5e44 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<ul class=\"pages-number number-page\">
";
        // line 2
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["pagination"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["pagination"], "S_IS_PREV", [], "any", false, false, false, 18)) {
                // line 19
                echo "\t\t<li class=\"arrow previous\"><a class=\"button button-icon-only hvr-sweep-to-top\" href=\"";
...
$context["pagination"], "S_IS_NEXT", [], "any", false, false, false, 24)) {
                // line 25
                echo "\t\t<li class=\"arrow next\"><a class=\"button button-icon-only hvr-sweep-to-top\" href=\"";
