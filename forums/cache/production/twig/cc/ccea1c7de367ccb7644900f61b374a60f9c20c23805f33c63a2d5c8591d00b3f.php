...
class __TwigTemplate_a60afdca5af85fcbf09d9dd71a9695002135c9de1e88de309fd9077462dc2c35 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "user_row", [], "any", false, false, false, 21))) {
            ...
            echo "\t\t<thead>
\t\t<tr>
\t\t\t<th class=\"name\"><a class=\"whois-marg\" href=\"";
            // line 24
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["user_row"]) {
                // line 31
                echo "\t\t<tr class=\"";
                if ((twig_get_attribute($this->env, $this->source, $context["user_row"], "S_ROW_COUNT", [], "any", false, false, false, 31) % 2 == 1)) {
                    echo "bg1";
                } else {
                    echo "bg2";
                }
