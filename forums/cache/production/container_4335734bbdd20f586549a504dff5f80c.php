...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'pa_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'pa_forums', 'pa_posts', 'pa_topics', 'pa_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('pa_captcha_questions', 'pa_captcha_answers', 'pa_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'pa_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'pa_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'pa_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_bbcodes', 'pa_smilies', 'pa_styles', 'pa_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'pa_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'pa_acl_groups',
            'tables.acl_options' => 'pa_acl_options',
            'tables.acl_roles' => 'pa_acl_roles',
            'tables.acl_roles_data' => 'pa_acl_roles_data',
            'tables.acl_users' => 'pa_acl_users',
            'tables.attachments' => 'pa_attachments',
            'tables.auth_provider_oauth_token_storage' => 'pa_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'pa_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'pa_oauth_accounts',
            'tables.banlist' => 'pa_banlist',
            'tables.bbcodes' => 'pa_bbcodes',
            'tables.bookmarks' => 'pa_bookmarks',
            'tables.bots' => 'pa_bots',
            'tables.captcha_qa_questions' => 'pa_captcha_questions',
            'tables.captcha_qa_answers' => 'pa_captcha_answers',
            'tables.captcha_qa_confirm' => 'pa_qa_confirm',
            'tables.config' => 'pa_config',
            'tables.config_text' => 'pa_config_text',
            'tables.confirm' => 'pa_confirm',
            'tables.disallow' => 'pa_disallow',
            'tables.drafts' => 'pa_drafts',
            'tables.ext' => 'pa_ext',
            'tables.extensions' => 'pa_extensions',
            'tables.extension_groups' => 'pa_extension_groups',
            'tables.forums' => 'pa_forums',
            'tables.forums_access' => 'pa_forums_access',
            'tables.forums_track' => 'pa_forums_track',
            'tables.forums_watch' => 'pa_forums_watch',
            'tables.groups' => 'pa_groups',
            'tables.icons' => 'pa_icons',
            'tables.lang' => 'pa_lang',
            'tables.log' => 'pa_log',
            'tables.login_attempts' => 'pa_login_attempts',
            'tables.migrations' => 'pa_migrations',
            'tables.moderator_cache' => 'pa_moderator_cache',
            'tables.modules' => 'pa_modules',
            'tables.notification_emails' => 'pa_notification_emails',
            'tables.notification_types' => 'pa_notification_types',
            'tables.notifications' => 'pa_notifications',
            'tables.poll_options' => 'pa_poll_options',
            'tables.poll_votes' => 'pa_poll_votes',
            'tables.posts' => 'pa_posts',
            'tables.privmsgs' => 'pa_privmsgs',
            'tables.privmsgs_folder' => 'pa_privmsgs_folder',
            'tables.privmsgs_rules' => 'pa_privmsgs_rules',
            'tables.privmsgs_to' => 'pa_privmsgs_to',
            'tables.profile_fields' => 'pa_profile_fields',
            'tables.profile_fields_data' => 'pa_profile_fields_data',
            'tables.profile_fields_options_language' => 'pa_profile_fields_lang',
            'tables.profile_fields_language' => 'pa_profile_lang',
            'tables.ranks' => 'pa_ranks',
            'tables.reports' => 'pa_reports',
            'tables.reports_reasons' => 'pa_reports_reasons',
            'tables.search_results' => 'pa_search_results',
            'tables.search_wordlist' => 'pa_search_wordlist',
            'tables.search_wordmatch' => 'pa_search_wordmatch',
            'tables.sessions' => 'pa_sessions',
            'tables.sessions_keys' => 'pa_sessions_keys',
            'tables.sitelist' => 'pa_sitelist',
            'tables.smilies' => 'pa_smilies',
            'tables.sphinx' => 'pa_sphinx',
            'tables.styles' => 'pa_styles',
            'tables.styles_template' => 'pa_styles_template',
            'tables.styles_template_data' => 'pa_styles_template_data',
            'tables.styles_theme' => 'pa_styles_theme',
            'tables.styles_imageset' => 'pa_styles_imageset',
            'tables.styles_imageset_data' => 'pa_styles_imageset_data',
            'tables.teampage' => 'pa_teampage',
            'tables.topics' => 'pa_topics',
            'tables.topics_posted' => 'pa_topics_posted',
            'tables.topics_track' => 'pa_topics_track',
            'tables.topics_watch' => 'pa_topics_watch',
            'tables.user_group' => 'pa_user_group',
            'tables.user_notifications' => 'pa_user_notifications',
            'tables.users' => 'pa_users',
            'tables.warnings' => 'pa_warnings',
            'tables.words' => 'pa_words',
            'tables.zebra' => 'pa_zebra',
            ...
            'tables' => [
                'acl_groups' => 'pa_acl_groups',
                'acl_options' => 'pa_acl_options',
                'acl_roles' => 'pa_acl_roles',
                'acl_roles_data' => 'pa_acl_roles_data',
                'acl_users' => 'pa_acl_users',
                'attachments' => 'pa_attachments',
                'auth_provider_oauth_token_storage' => 'pa_oauth_tokens',
                'auth_provider_oauth_states' => 'pa_oauth_states',
                'auth_provider_oauth_account_assoc' => 'pa_oauth_accounts',
                'banlist' => 'pa_banlist',
                'bbcodes' => 'pa_bbcodes',
                'bookmarks' => 'pa_bookmarks',
                'bots' => 'pa_bots',
                'captcha_qa_questions' => 'pa_captcha_questions',
                'captcha_qa_answers' => 'pa_captcha_answers',
                'captcha_qa_confirm' => 'pa_qa_confirm',
                'config' => 'pa_config',
                'config_text' => 'pa_config_text',
                'confirm' => 'pa_confirm',
                'disallow' => 'pa_disallow',
                'drafts' => 'pa_drafts',
                'ext' => 'pa_ext',
                'extensions' => 'pa_extensions',
                'extension_groups' => 'pa_extension_groups',
                'forums' => 'pa_forums',
                'forums_access' => 'pa_forums_access',
                'forums_track' => 'pa_forums_track',
                'forums_watch' => 'pa_forums_watch',
                'groups' => 'pa_groups',
                'icons' => 'pa_icons',
                'lang' => 'pa_lang',
                'log' => 'pa_log',
                'login_attempts' => 'pa_login_attempts',
                'migrations' => 'pa_migrations',
                'moderator_cache' => 'pa_moderator_cache',
                'modules' => 'pa_modules',
                'notification_emails' => 'pa_notification_emails',
                'notification_types' => 'pa_notification_types',
                'notifications' => 'pa_notifications',
                'poll_options' => 'pa_poll_options',
                'poll_votes' => 'pa_poll_votes',
                'posts' => 'pa_posts',
                'privmsgs' => 'pa_privmsgs',
                'privmsgs_folder' => 'pa_privmsgs_folder',
                'privmsgs_rules' => 'pa_privmsgs_rules',
                'privmsgs_to' => 'pa_privmsgs_to',
                'profile_fields' => 'pa_profile_fields',
                'profile_fields_data' => 'pa_profile_fields_data',
                'profile_fields_options_language' => 'pa_profile_fields_lang',
                'profile_fields_language' => 'pa_profile_lang',
                'ranks' => 'pa_ranks',
                'reports' => 'pa_reports',
                'reports_reasons' => 'pa_reports_reasons',
                'search_results' => 'pa_search_results',
                'search_wordlist' => 'pa_search_wordlist',
                'search_wordmatch' => 'pa_search_wordmatch',
                'sessions' => 'pa_sessions',
                'sessions_keys' => 'pa_sessions_keys',
                'sitelist' => 'pa_sitelist',
                'smilies' => 'pa_smilies',
                'sphinx' => 'pa_sphinx',
                'styles' => 'pa_styles',
                'styles_template' => 'pa_styles_template',
                'styles_template_data' => 'pa_styles_template_data',
                'styles_theme' => 'pa_styles_theme',
                'styles_imageset' => 'pa_styles_imageset',
                'styles_imageset_data' => 'pa_styles_imageset_data',
                'teampage' => 'pa_teampage',
                'topics' => 'pa_topics',
                'topics_posted' => 'pa_topics_posted',
                'topics_track' => 'pa_topics_track',
                'topics_watch' => 'pa_topics_watch',
                'user_group' => 'pa_user_group',
                'user_notifications' => 'pa_user_notifications',
                'users' => 'pa_users',
                'warnings' => 'pa_warnings',
                'words' => 'pa_words',
                'zebra' => 'pa_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'pa_',
